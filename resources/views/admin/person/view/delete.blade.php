<div class="modal fade" id="form_delete" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog"
     aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <form method="post" id="bt_submit_delete">
            @csrf
            @method('DELETE')
                ...
                <div class="modal-body">
                    <div class="text-center mb-4">
                        ...
                        <div class="text-muted fw-semibold fs-6 mb-4">
                            Anda akan menghapus data person:
                            <div class="text-dark fw-bold fs-4 mt-2" id="delete_nama"></div>
